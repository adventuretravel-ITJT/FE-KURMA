...
const steps: { id: Panel; icon: React.ReactNode; time: string; title: string; desc: string }[] = [
  {
    ...
    desc: 'Open your itinerary for the day — every activity is timed, tagged, and ready. No more fumbling through notes or PDFs.',
  },
  {
    id: 'afternoon',
    icon: (
    ...
    title: 'Browse the city guide',
    desc: 'Check what to eat nearby, local tips, and your checklist — all in the same screen.',
  },
  {
    id: 'evening',
    icon: (
    ...
    desc: 'Restaurant reservation just arrived? Drop it straight into the activity card. Everything in context, nothing lost.',
  },
  {
    id: 'night',
    icon: (
    ...
    desc: "Send the itinerary to your travel companions. One link, everyone's on the same page.",
  },
]
  ...
  return (
    <div className="hp-day-mockup-wrap">
      ...
      <div className="hp-day-mockup-body">
        ...
        <div className="hp-dm-activity highlighted">
          <span className="hp-dm-time">08:00</span>
          <span className="hp-dm-name">Fushimi Inari Shrine</span>
          <span className="hp-dm-tag tag-culture">Culture</span>
        </div>
        <div className="hp-dm-activity">
          <span className="hp-dm-time">11:30</span>
          <span className="hp-dm-name">Nishiki Market</span>
          <span className="hp-dm-tag tag-food">Food</span>
        </div>
        <div className="hp-dm-activity">
          <span className="hp-dm-time">14:00</span>
          <span className="hp-dm-name">Arashiyama Bamboo Grove</span>
          <span className="hp-dm-tag tag-activity">Activity</span>
        </div>
        <div className="hp-dm-activity">
          <span className="hp-dm-time">17:30</span>
          <span className="hp-dm-name">Gion District Walk</span>
          <span className="hp-dm-tag tag-culture">Culture</span>
        </div>
      </div>
    </div>
...
function AfternoonPanel() {
  return (
    <div className="hp-day-mockup-wrap">
      <MockupBar />
      <div className="hp-day-mockup-body">
        <div className="hp-cg-panel-header">
          <div>
            <div className="hp-dm-day-label">City guide</div>
            <div className="hp-cg-city-name">Kyoto</div>
          </div>
          <div style={{ textAlign: 'right' }}>
            <div className="hp-cg-panel-temp">22°</div>
            <div className="hp-cg-panel-condition">Partly cloudy</div>
          </div>
        </div>
        <div className="hp-cg-tabs">
          <div className="hp-cg-tab on">Must-eat</div>
          <div className="hp-cg-tab">Checklist</div>
          <div className="hp-cg-tab">Local tips</div>
        </div>
        <div className="hp-cg-eat-item">
          <div className="hp-cg-eat-icon"><IconUtensils /></div>
          <div><div className="hp-cg-eat-name">Nishiki Market lunch</div><div className="hp-cg-eat-type">Street food · ¥800–1,200</div></div>
        </div>
        <div className="hp-cg-eat-item">
          <div className="hp-cg-eat-icon"><IconCup /></div>
          <div><div className="hp-cg-eat-name">Mitarashi dango</div><div className="hp-cg-eat-type">Snack · near Shimogamo</div></div>
        </div>
        <div className="hp-cg-eat-item">
          <div className="hp-cg-eat-icon"><IconPlate /></div>
          <div><div className="hp-cg-eat-name">Kaiten-zushi Musashi</div><div className="hp-cg-eat-type">Dinner · ¥1,500–2,500</div></div>
        </div>
      </div>
    </div>
  )
...
const IconBuilding = () => (
  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M9 22v-4h6v4"/>
    <path d="M8 6h.01M16 6h.01M12 6h.01M12 10h.01M16 10h.01M8 10h.01M8 14h.01M16 14h.01M12 14h.01"/>
  </svg>
)
  ...
  return (
    <div className="hp-day-mockup-wrap">
      ...
      <div className="hp-day-mockup-body">
        ...
        <div className="hp-share-person">
          <div className="hp-share-avatar" style={{ background: 'var(--accent-bg)', color: 'var(--accent)' }}>R</div>
          <div className="hp-share-name">Rania</div>
          <div className="hp-share-status hp-status-accepted">Accepted</div>
        </div>
        <div className="hp-share-person">
          <div className="hp-share-avatar" style={{ background: 'var(--warm-bg)', color: 'var(--warm)' }}>D</div>
          <div className="hp-share-name">Dimas</div>
    ...
    <section className="hp-section hp-daytime" id="experience">
      <div className="hp-wrap">
        <div style={{ marginBottom: 56 }}>
          ...
          <h2 className="hp-h2 reveal">See how Kurma works<br /><em>in a real day.</em></h2>
          <p className="hp-section-sub reveal">Tap each moment to see Kurma in action — from morning plans to evening prep.</p>
        </div>
