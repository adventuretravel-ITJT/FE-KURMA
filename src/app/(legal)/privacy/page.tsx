    ...
    <div className="legal-root">
      ...
      <section className="lp-hero">
        <div className="lp-hero-inner">
          ...
          <h1 className="lp-hero-title">{page?.title ?? 'Privacy Policy'}</h1>
          <p className="lp-hero-lead">
            {page?.meta_description ?? 'This Privacy Policy describes how KurmaGo collects, uses, discloses, and safeguards your personal information when you access or use our services.'}
          </p>
            ...
            <main className="lp-content">
              ...
              <section className="lp-section" id="s04">
                ...
                <table className="lp-data-table">
                  <thead>
                    <tr><th>Partner Category</th><th>Purpose</th><th>Data Accessed</th></tr>
                  </thead>
                  <tbody>
