...
export default function PrivacyPolicyEditor() {
  ...
  const [form, setForm]     = useState({ title: 'Privacy Policy', meta_description: '', content: '', is_published: false });
      ...
      {loading ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20, background: '#fff', border: '1px solid #E5DFD0', borderRadius: 12, padding: 28 }}>
          ...
          <div>
            ...
            <input style={inputStyle} value={form.title} onChange={e => setForm(f => ({ ...f, title: e.target.value }))} placeholder="Privacy Policy" />
          </div>
          ...
          <div>
            <label style={labelStyle}>
              Konten *{' '}
              <span style={{ fontWeight: 400, textTransform: 'none', color: '#8A95A2' }}>(HTML — akan dirender langsung di halaman /privacy)</span>
            </label>
